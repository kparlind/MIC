...
Public Class FrmPencairanGiroView
    ...
    Private Sub FrmPencairanGiroView_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadPH()
        ...
        Try
            ...
            Cmd.CommandText = "Select Giro_No from Trans_PencairanGiro"
            ...
            dView.Sort = "Giro_No ASC"
            cb_PH.Items.Insert(0, "All")
            cb_PH.Items.Item(0) = "All"
            While i < dt_TB.Rows.Count
                cb_PH.Items.Insert(i + 1, dt_TB.Rows(i).Item("Giro_No"))
                cb_PH.Items.Item(i + 1) = dt_TB.Rows(i).Item("Giro_No")
                i = i + 1
            End While
    ...
    Private Sub btn_cari_Click1(sender As Object, e As System.EventArgs) Handles btn_cari.Click
        Try
            dt.Clear()
            If Conn.State = ConnectionState.Closed Then
                Conn.Open()
            ...
            Cmd.CommandText = "EXEC sp_Retreive_View_PencairanGiro '" + TBDate_Fr.Value.ToString("MM/dd/yyyy") + "','" & _
    ...
    Private Sub gv_DoubleClick1(sender As Object, e As System.EventArgs) Handles gv.DoubleClick
        If dt.Rows.Count > 0 Then
            ...
            With frmChild
                .txt_nogiro.Text = gv.CurrentRow.DataGridView(0, gv.CurrentRow.Index).Value
    ...
    Private Sub btn_new_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim frmChild As New Frm_PencairanGiro
