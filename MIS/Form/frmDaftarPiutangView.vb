...
Public Class frmDaftarPiutangView
    ...
    Private Sub frmDaftarPiutangView_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadPH()
        ...
        Try
            ...
            Cmd.CommandText = "Select DPP_No from Trans_DaftarPembayaranPiutang_Hdr where DPP_Date between '" & TBDate_Fr.Value.ToString("MM/dd/yyyy") & "' and '" & TBDate_To.Value.ToString("MM/dd/yyyy") & "'"
            ...
            dView.Sort = "DPP_No ASC"
            cb_PH.Items.Insert(0, "All")
            cb_PH.Items.Item(0) = "All"
            While i < dt_TB.Rows.Count
                cb_PH.Items.Insert(i + 1, dt_TB.Rows(i).Item("DPP_No"))
                cb_PH.Items.Item(i + 1) = dt_TB.Rows(i).Item("DPP_No")
                i = i + 1
            End While
    ...
    Private Sub btn_cari_Click(sender As Object, e As System.EventArgs) Handles btn_cari.Click
        Try
            ...
            Cmd.CommandText = "EXEC sp_Retreive_View_DaftarPiutang '" + TBDate_Fr.Value.ToString("MM/dd/yyyy") + "','" & _
    ...
    End Sub
     ...
     Private Sub gv_DoubleClick(sender As Object, e As System.EventArgs) Handles gv.DoubleClick
        ...
        If dt.Rows.Count > 0 Then
            Dim frmChild As New frmDaftarPembayaranPiutang
            For Each f As Form In Me.MdiChildren
                If f.Name = "frmDaftarPembayaranPiutang" Then
                    f.BringToFront()
                    Exit Sub
                End If
            Next
            ...
            With frmChild
                ...
                .txt_emp.Text = gv.CurrentRow.DataGridView(3, gv.CurrentRow.Index).Value
                ...
                If .txt_emp.Text <> "" Then
                    Try
                        ...
                        Cmd.CommandText = "Select name from master_employee where employee_id = '" & .txt_emp.Text & "'"
                        DA.SelectCommand = Cmd
                        DA.Fill(dtemp)
                        If dtemp.Rows.Count > 0 Then
                            .txt_NmKolektor.Text = dtemp.Rows(0).Item("name")
                        End If
