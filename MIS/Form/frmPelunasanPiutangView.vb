...
Public Class frmPelunasanPiutangView
    ...
    Private Sub frmPelunasanPiutangView_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadPH()
        ...
        Try
            ...
            Cmd.CommandText = "Select PP_No from Trans_PelunasanPiutang_Hdr where Tgl_Pelunasan between '" & TBDate_Fr.Value.ToString("MM/dd/yyyy") & "' and '" & TBDate_To.Value.ToString("MM/dd/yyyy") & "'"
            ...
            dView.Sort = "PP_No ASC"
            cb_PH.Items.Insert(0, "All")
            cb_PH.Items.Item(0) = "All"
            While i < dt_TB.Rows.Count
                cb_PH.Items.Insert(i + 1, dt_TB.Rows(i).Item("PP_No"))
                cb_PH.Items.Item(i + 1) = dt_TB.Rows(i).Item("PP_No")
                i = i + 1
            End While
    ...
    Private Sub btn_cari_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_cari.Click
        Try
            ...
            Cmd.CommandText = "EXEC sp_Retreive_View_PelunasanPiutang '" + TBDate_Fr.Value.ToString("MM/dd/yyyy") + "','" & _
    ...
    Private Sub gv_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles gv.DoubleClick
        If dt.Rows.Count > 0 Then
            Dim frmChild As New FrmPelunasanPiutang
            For Each f As Form In Me.MdiChildren
                If f.Name = "frmPelunasanPiutang" Then
                    f.BringToFront()
                    Exit Sub
                End If
            Next
            ...
            With frmChild
                ...
                .txt_emp.Text = gv.CurrentRow.DataGridView(2, gv.CurrentRow.Index).Value.ToString
                .txt_NmKolektor.Text = gv.CurrentRow.DataGridView(3, gv.CurrentRow.Index).Value.ToString
                .txt_Ket.Text = gv.CurrentRow.DataGridView(4, gv.CurrentRow.Index).Value.ToString
                .txtPeriod.Text = gv.CurrentRow.DataGridView(5, gv.CurrentRow.Index).Value.ToString
                .Show()
            End With
        End If
    End Sub
