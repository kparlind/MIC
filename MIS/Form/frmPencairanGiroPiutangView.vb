...
Public Class frmPencairanGiroPiutangView
    ...
    Private Sub LoadPH()
        ...
        Try
            ...
            Cmd.CommandText = "Select Giro_No from Trans_PencairanGiroPiutang"
    ...
    Private Sub btn_cari_Click(sender As Object, e As System.EventArgs) Handles btn_cari.Click
        Try
            ...
            Cmd.CommandText = "EXEC sp_Retreive_View_PencairanGiroPiutang '" + TBDate_Fr.Value.ToString("MM/dd/yyyy") + "','" & _
    ...
    Private Sub frmPencairanGiroPiutangView_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
