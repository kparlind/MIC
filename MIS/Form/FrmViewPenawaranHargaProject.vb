...
Public Class FrmViewPenawaranHargaProject
    ...
    Private Sub FrmViewPenawaranHargaProject_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub SetGrid()
        ...
        gv.Columns(2).HeaderText = "Survey#"
        ...
        gv.Columns(5).Width = 220
        gv.Columns(5).HeaderText = "Remarks"

        gv.Columns(6).Width = 80
        gv.Columns(6).HeaderText = "Status"

        gv.Columns(7).Width = 165
        gv.Columns(7).HeaderText = "Status Description"
    End Sub
    ...
    Private Sub btn_cari_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_cari.Click
        Try
            ...
            Cmd.CommandText = "EXEC sp_Retrieve_View_PenawaranHargaProject '" & Format(dt_from.Value, "yyyyMMdd") & "','" & _
    ...
    Private Sub ts_New_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ts_New.Click
        Dim frmChild As New FrmPenawaranHargaProject

        For Each f As Form In Me.MdiChildren
            If f.Name = "FrmPenawaranHargaProject" Then
                f.BringToFront()
                Exit Sub
            End If
        Next
    ...
    Private Sub gv_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles gv.DoubleClick
        If dt.Rows.Count > 0 Then
            ...
            LoadFromView = True
            id_status = gv.CurrentRow.DataGridView(6, gv.CurrentRow.Index).Value.ToString.Trim
            With frmChild
                .MdiParent = MDIFrm
