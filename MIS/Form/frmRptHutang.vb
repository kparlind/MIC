...
Public Class frmRptHutang
    ...
    Private Sub frmRptHutang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    'Private Sub txtkdSupplier2_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtkdSupplier1.KeyDown
    '    If e.KeyCode = Keys.F1 Then
    '        CallandGetSearchData("Select Supp_ID,Nama from Master_Supplier where active_flag = 'Y'", "Supp_ID", "Nama", "", "", "", "")
    '        txtkdSupplier1.Text = frmSearch.txtResult1.Text.ToString.Trim
    '        If txtkdSupplier2.Text = "" Then
    ...
    Private Sub CalculateGLRangeCOA(ByVal kd1 As String, ByVal kd2 As String, ByVal dt1 As DateTime, ByVal dt2 As DateTime)
        ...
        Try
            ...
            Cmd.CommandText = "exec sp_GetLastSaldoPembayaranHutang '" & kd1 & "','" & kd2 & "','" & dt1 & "'"
        ...
        Try
            ...
            Cmd.CommandText = "exec sp_getPembayaranKartuHutang '" & kd1 & "','" & kd2 & "','" & dt1 & "','" & dt2 & "'"
        ...
        While j < dtSaldo.Rows.Count
            While i < dtHutang.Rows.Count
                ...
                If dtSaldo.Rows(j).Item("tb_no") = dtHutang.Rows(i).Item("tb_no") Then
                    If counter = 0 Then
                    ...
                    End If
                    tempSaldoAkhir = tempSaldoAkhir - CDbl(dtHutang.Rows(i).Item("jumlah_bayar")) - CDbl(dtHutang.Rows(i).Item("retur")) - CDbl(dtHutang.Rows(i).Item("potongan"))
        ...
        frmChild.ReportName = "Report Hutang"
        frmChild.dtHutang = dtHutang
        frmChild.Show()
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        If txtkdSupplier1.Text = "" And txtkdSupplier2.Text = "" Then
            MessageBox.Show("Kode Supplier must be filled.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
            Exit Sub
        End If
    ...
    Private Sub txtkdSupplier2_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtkdSupplier2.KeyDown
        If e.KeyCode = Keys.F1 Then
            CallandGetSearchData("Select Supp_ID,Nama from Master_Supplier where active_flag = 'Y'", "Supp_ID", "Nama", "", "", "", "")
            ' txtkdSupplier1.Text = frmSearch.txtResult1.Text.ToString.Trim
            txtkdSupplier2.Text = frmSearch.txtResult1.Text.ToString.Trim
