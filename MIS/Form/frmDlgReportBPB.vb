Public Class frmDlgReportBPB
    ...
    Private Sub btnViewReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnViewReport.Click
        ...
        frmChild.ReportName = "Report BPB"

        frmChild.Show()
        Me.Close()
    End Sub

    Private Sub frmDlgReportBPB_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
