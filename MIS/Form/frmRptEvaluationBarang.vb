Public Class frmRptEvaluationBarang
    Public Category As String
    Public Type As String
    Public Supp_ID As String
    Public DateFrom As String
    Public DateTo As String
    Private Sub frmRptEvaluationBarang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
